    ...
    <div className="px-4 py-6 flex flex-col gap-6">
        ...
        {activeOutage ? (
          <>
            <div
              ...
              style={{ backgroundColor: '#1E293B', border: '1px solid rgba(231,76,60,0.35)' }}
            >
              <span
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-bold uppercase tracking-widest" style={{ color: '#E74C3C' }}>
                  Outage in progress
                </p>
      ...
      {!activeOutage && (
        <button
          ...
          style={{ border: '1px solid rgba(46,204,113,0.4)', color: '#2ECC71', backgroundColor: 'transparent' }}
        >
        ...
        {outages.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {monthGroups.map(({ key, label, records }) => {
              ...
              return (
                <div key={key} className="rounded-card overflow-hidden" style={{ backgroundColor: '#1E293B', border: '1px solid #334155' }}>
                  <button
                    onClick={() => toggleMonth(key)}
                    className="w-full flex items-center justify-between px-4 py-3"
                    style={{ borderBottom: collapsed ? 'none' : '1px solid #334155' }}
                  >
                    ...
                    <div key={outage.id}>
                      {editId === outage.id ? (
                        <div
                          ...
                          style={{ borderBottom: idx < records.length - 1 ? '1px solid #334155' : 'none' }}
                        >
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 py-2 rounded-btn text-sm font-semibold"
                              style={{ backgroundColor: '#2ECC71', color: '#0F172A' }}
                            >
                              Save
                            </button>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 flex-wrap">
                              ...
                              <span className="text-xs text-textMuted">
                                ...
                                {' – '}
                                {outage.is_active ? (
                                  <span className="font-semibold px-1.5 py-0.5 rounded-full" style={{ backgroundColor: '#E74C3C22', color: '#E74C3C', border: '1px solid #E74C3C55' }}>
                                    Active
                                  </span>
                                ) : (
        ...
        >
          ...
          >
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: '#94A3B8' }}>This action cannot be undone.</p>
            </div>
